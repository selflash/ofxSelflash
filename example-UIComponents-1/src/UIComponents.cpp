...
void UIComponents::_setup() {
    ...
    label->y(marginTop + lineSpacing * 0 + 2);
    ...
    label->text("Slider2");
    label->x(marginLeft + spacing * 0);
    label->y(marginTop + lineSpacing * 2 + 2);
    label->textColor(FlashConfig::UI_LABEL_NORMAL_COLOR);
    label->mouseEnabled(false);
    addChild(label);
    ...
    label->x(marginLeft + spacing * 0);
    label->y(marginTop + lineSpacing * 4 + 2);
    label->textColor(FlashConfig::UI_LABEL_NORMAL_COLOR);
    label->mouseEnabled(false);
    addChild(label);
    ...
    label->x(marginLeft + spacing * 0);
    label->y(marginTop + lineSpacing * 6 + 2);
    label->textColor(FlashConfig::UI_LABEL_NORMAL_COLOR);
    label->mouseEnabled(false);
    addChild(label);
    ...
    colorSlider001->y(marginTop + lineSpacing * 0 + 22.5 + 2);
