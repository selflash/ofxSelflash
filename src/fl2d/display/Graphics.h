...
#define COMMAND_BEGIN_FILL            0
#define COMMAND_BEGIN_GRADIENT_FILL   1
#define COMMAND_END_FILL              2
#define COMMAND_DRAW_CIRCLE           3
#define COMMAND_DRAW_ELLIPSE          4
#define COMMAND_DRAW_RECT             5
#define COMMAND_DRAW_ROUNDRECT        6
#define COMMAND_LINESTYLE             7
#define COMMAND_LINE_TO               8
#define COMMAND_MOVE_TO               9
#define COMMAND_CURVE_TO             10
#define COMMAND_CLEAR                11
