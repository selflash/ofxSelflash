...
namespace fl2d {
    //水平
    string Joystick1::HORIZONTALLY = "horizontally";
    //垂直
    string Joystick1::VERTICALLY = "vertically";
    ...
    //--------------------------------------------------------------
    //
    Joystick1::Joystick1(float length, float leverDiameter) {
        ...
        lever->addEventListener(MouseEvent::ROLL_OVER, this, &Joystick1::_mouseEventHandler);
        lever->addEventListener(MouseEvent::ROLL_OUT, this, &Joystick1::_mouseEventHandler);
        lever->addEventListener(MouseEvent::MOUSE_DOWN, this, &Joystick1::_mouseEventHandler);
        lever->addEventListener(MouseEvent::MOUSE_MOVE, this, &Joystick1::_mouseEventHandler);
        lever->addEventListener(MouseEvent::DRAGGING, this, &Joystick1::_mouseEventHandler);
        addChild(lever);
    ...
    Joystick1::~Joystick1() {
        ...
        removeEventListener(MouseEvent::ROLL_OVER, this, &Joystick1::_mouseEventHandler);
        removeEventListener(MouseEvent::ROLL_OUT, this, &Joystick1::_mouseEventHandler);
        
        lever->removeEventListener(MouseEvent::ROLL_OVER, this, &Joystick1::_mouseEventHandler);
        lever->removeEventListener(MouseEvent::ROLL_OUT, this, &Joystick1::_mouseEventHandler);
        lever->removeEventListener(MouseEvent::MOUSE_DOWN, this, &Joystick1::_mouseEventHandler);
        lever->removeEventListener(MouseEvent::MOUSE_MOVE, this, &Joystick1::_mouseEventHandler);
        lever->removeEventListener(MouseEvent::DRAGGING, this, &Joystick1::_mouseEventHandler);
    ...
    //--------------------------------------------------------------
    //
    void Joystick1::_setup() {
        //cout << "[SimpleSlider]setup()" << endl;
    }
    
    //--------------------------------------------------------------
    //
    void Joystick1::_update() {
        ...
        if(lever->isMouseDown()) {
            ...
            //------------------------------------------
            Joystick1Event* event;
            event = new Joystick1Event(Joystick1Event::CHANGE);
            ...
            if(_type == VERTICALLY) {
                if(_value > 0) {
                    event = new Joystick1Event(Joystick1Event::RIGHT);
                    event->__value = _value;
                    dispatchEvent(event);
                }
                if(_value < 0) {
                    event = new Joystick1Event(Joystick1Event::LEFT);
                    event->__value = _value;
                    dispatchEvent(event);
                }
            } else
                ...
                if(_type == HORIZONTALLY) {
                    if(_value > 0) {
                        event = new Joystick1Event(Joystick1Event::UP);
                        event->__value = _value;
                        dispatchEvent(event);
                    }
                    if(_value < 0) {
                        event = new Joystick1Event(Joystick1Event::DOWN);
                        event->__value = _value;
                        dispatchEvent(event);
                    }
                }
            ...
            if(_type == VERTICALLY) {
                ...
                if(-0.5f < distanceX && distanceX < 0.5f) {
                    ...
                    Joystick1Event* event = new Joystick1Event(Joystick1Event::CHANGE);
                    event->__value = _value;
                    dispatchEvent(event);
                }
            } else
...
//        _flgX = false;
    ...
    //--------------------------------------------------------------
    //
    TextField* Joystick1::label() { return _label; }
    void Joystick1::label(TextField* value) { _label = value; }
    
    //--------------------------------------------------------------
    //
    string Joystick1::type() { return _type; }
    void Joystick1::type(string value) {
        _type = value;
    ...
    //--------------------------------------------------------------
    //
    float Joystick1::value() { return _value; }
    
    //--------------------------------------------------------------
    //
    void Joystick1::moveLever(float value) {
    ...
    //--------------------------------------------------------------
    //
    bool Joystick1::enabled() { return _enabled; }
    void Joystick1::enabled(bool value) {
        _enabled = value;
    ...
    //--------------------------------------------------------------
    //
    void Joystick1::_areaPress() {
        
    }
    //--------------------------------------------------------------
    //
    void Joystick1::_areaRelease() {
        
    }
    
    //--------------------------------------------------------------
    //
    void Joystick1::_ballOver() {
        if(lever->isMouseDown()) return;
    ...
    //--------------------------------------------------------------
    //
    void Joystick1::_mouseEventHandler(Event& event) {
        ...
        if(event.type() == MouseEvent::MOUSE_DOWN) {
            ...
            if(event.target() == lever){
                _ballPress();
                stage()->addEventListener(MouseEvent::MOUSE_UP, this, &Joystick1::_mouseEventHandler);
            }
        }
        ...
        if(event.type() == MouseEvent::MOUSE_UP) {
            ...
            if(event.currentTarget() == stage()){
                _ballRelease();
                stage()->removeEventListener(MouseEvent::MOUSE_UP, this, &Joystick1::_mouseEventHandler);
            }
        }
