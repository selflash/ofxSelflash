...
//    _bokehDof = NULL;
    //------------------------------------------
//    _bufferWidth = ofGetWidth();
//    _bufferHeight = ofGetHeight();
//    
//    _renderedBuffer = NULL;
...
//    _cameraList.push_back(camera);
    ...
    _glslAssister->camera = _camera->camera();
    //----------------------------------
...
//    //------------------------------------------
//    _depthShader = new ofShader();
//    _depthShader->load("flash/fl3d/shaders/depth.vert", "flash/fl3d/shaders/depth.frag");
//    
...
//    
//    _renderedBuffer = new ofFbo();
//    _renderedBuffer->allocate(settings);
...
//    
//    _depthMapBuffer = new ofFbo();
//    _depthMapBuffer->allocate(settings);
...
//    settings.wrapModeVertical = GL_CLAMP_TO_EDGE;
//    
//    _depthBuffer = new ofFbo();
//    _depthBuffer->allocate(settings);
//    _depthBuffer->begin();
//    glClearColor(0.0, 0.0, 0.0, 0.0);
...
//    cout << _camera->x() << ", " << _camera->y() << ", " << _camera->z() << endl;
    ...
    _glslAssister->nearClip(_camera->nearClip());
    _glslAssister->farClip(_camera->farClip());
    _glslAssister->focalLength(_camera->focalDistance());
    _glslAssister->focalDepth(_camera->focalLength());
    
    //    _bokehDof->nearClip(_camera->nearClip());
    //    _bokehDof->farClip(_camera->farClip());
//    _bokehDof->focalLength(_camera->focalDistance());
//    _bokehDof->focalDepth(_camera->focalLength());
//    _bokehDof->fstop(_camera->fstop());
    
    float elapsedTime = ofGetElapsedTimef();

    
//    _glLight->position((ofGetWidth() * 0.5) + cos(elapsedTime * 0.5) * (ofGetWidth() * 0.3), ofGetHeight() / 2, 500);
//    _glLight->position(
//                       cos(elapsedTime * 1.5) * ofGetWidth() * 0.5,
//                       sin(elapsedTime * 1.5f) * ofGetWidth() * 0.5,
//                       cos(elapsedTime * 0.2) * ofGetWidth()
//                       );

//    ofVec3f pos = _camera->screenToWorld(ofGetMouseX(), ofGetMouseY(), 0);
//    pos.z = sin(elapsedTime) * 5000;
//    _glLight->position(pos);
    
//    _glLight->position(ofGetMouseX() , ofGetMouseY() , sin(elapsedTime) * 5000);
    _glLight->position(ofGetMouseX()*10- ofGetWidth()*10 * 0.5, -ofGetMouseY()*10+ ofGetHeight()*10 * 0.5, 500);
//    _glLight->position(ofGetMouseX(), -ofGetMouseY(), 500);
//    cout << pos.z << endl;
